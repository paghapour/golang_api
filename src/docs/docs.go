...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_paghapour_golang-clean-web-api_api_dto.CreateCityRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_paghapour_golang-clean-web-api_api_dto.UpdateCityRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "result": {
                                            "$ref": "#/definitions/github_com_paghapour_golang-clean-web-api_api_dto.FileResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "result": {
                                            "$ref": "#/definitions/github_com_paghapour_golang-clean-web-api_api_dto.PagedList-github_com_paghapour_golang-clean-web-api_api_dto_FileResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_paghapour_golang-clean-web-api_api_dto.UpdateFileRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_paghapour_golang-clean-web-api_api_dto.CreateCityRequest": {
            "type": "object",
            "required": [
                "countryId",
                "name"
        ...
        "github_com_paghapour_golang-clean-web-api_api_dto.FileResponse": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "github_com_paghapour_golang-clean-web-api_api_dto.PagedList-github_com_paghapour_golang-clean-web-api_api_dto_FileResponse": {
            "type": "object",
            "properties": {
                "hasNextPage": {
                    "type": "boolean"
        ...
        "github_com_paghapour_golang-clean-web-api_api_dto.UpdateCityRequest": {
            "type": "object",
            "properties": {
                "countryId": {
                    "type": "integer"
        ...
        "github_com_paghapour_golang-clean-web-api_api_dto.UpdateFileRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
